...
def create_connection_anomaly_chart(ax, layer_connections, layers, threshold=1.0, medium_font=None, large_font=None):
    """
    ...
    nodes = nx.draw_networkx_nodes(G, pos, node_size=1000, 
                                 node_color='lightblue', alpha=0.6, ax=ax)

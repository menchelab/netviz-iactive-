...
class LayerCommunitiesPanel(BaseStatsPanel):
    ...
    def setup_ui(self):
        ...
        self.enable_checkbox = QCheckBox("Enable Community Detection")
        ...
        self.heatmap_ax = self.figure.add_subplot(gs[0])  # Top row (30%)
    ...
    def on_state_changed(self, state):
        ...
        if self._current_data and state:
            ...
            create_layer_communities_chart(
                self.heatmap_ax, self.network_ax,
            ...
            self.heatmap_ax.text(0.5, 0.5, "Community detection disabled", 
                               ha='center', va='center', fontsize=12)
            self.heatmap_ax.axis('off')
            
            self.network_ax.text(0.5, 0.5, "Community detection disabled", 
                               ha='center', va='center', fontsize=12)
    ...
    def update_stats(self, data_manager):
        """Update the Layer Communities visualization with current data"""
        # Clear figure
        self.figure.clear()

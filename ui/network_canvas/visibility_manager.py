...
class VisibilityManager:
    ...
    def update_visibility(
        ...
        # Pass node_size and node_opacity here
    ...
    def _calculate_interlayer_edge_counts(self, edge_mask):
        ...
        for i, (start_idx, end_idx) in enumerate(self.canvas.link_pairs):
            ...
            if edge_mask is not None and not edge_mask[i]: # Added check for None edge_mask
                continue
    ...
    # Modify signature to accept scale and opacity

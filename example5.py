...
class NetworkStatsPanel(QWidget):
    ...
    def update_stats(self, node_positions, link_pairs, node_ids, layers, node_clusters, node_mask, edge_mask):
        ...
        # 2a. Plot top 20 nodes by intralayer connections
...
class MultilayerNetworkViz(QWidget):
    def __init__(self, node_positions=None, link_pairs=None, link_colors=None, node_ids=None, 
        ...
        self.resize(1200, 800)  # Increased width to accommodate stats panel
        self.show()
    ...
    def update_visibility(self):
        ...
        if len(visible_nodes) == 0:
            ...
            self.stats_panel.update_stats(
                ...
                self.layers, self.node_clusters, node_mask, np.zeros(len(self.link_pairs), dtype=bool)
            )
            return

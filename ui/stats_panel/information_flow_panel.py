...
class InformationFlowPanel(BaseStatsPanel):
    ...
    def setup_ui(self):
        ...
        self.enable_checkbox = QCheckBox("Enable Information Flow")
    ...
    def on_state_changed(self, state):
        ...
        if self._current_data and state:
            ...
            self.flow_ax.text(0.5, 0.5, "Information flow disabled", 
                            ha='center', va='center', fontsize=12)
            self.flow_ax.axis('off')
            
            self.network_ax.text(0.5, 0.5, "Information flow disabled", 
                               ha='center', va='center', fontsize=12)

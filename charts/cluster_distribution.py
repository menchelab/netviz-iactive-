...
def create_cluster_distribution_chart(ax, visible_node_ids, node_clusters, small_font, medium_font, cluster_colors=None):
    """Create pie chart showing cluster distribution"""
    cluster_counts = collections.Counter([node_clusters[node_id] for node_id in visible_node_ids])
    ...
    if cluster_counts:
        ...
        ax.pie(counts, labels=clusters, autopct='%1.1f%%', 
              startangle=90, textprops=small_font, colors=colors)

...
class EdgeManager:
    ...
    def _add_interlayer_edge(self, start_idx, end_idx, edge_idx, interlayer_edges):
        ...
        if self.canvas.data_manager.layer_colors_rgba and start_layer_name in self.canvas.data_manager.layer_colors_rgba:
            edge_color = self.canvas.data_manager.layer_colors_rgba[start_layer_name].copy()

...
def create_layer_similarity_chart(
    ax, layer_connections, layers, small_font, medium_font
):
    ...
    if len(layers) > 1 and np.sum(layer_connections) > 0:
        ...
        if max_connections > 0:
            ...
            ax.text(
                0.5,
                0.5,
                "No layer connections to analyze",
        ...
        ax.text(
            0.5,
            0.5,
            "Not enough layers for similarity analysis",
            horizontalalignment="center",
            verticalalignment="center",
            **small_font,
        )
